#! sudo pip install telepot telegramfrom datetime import datetime
import time
import telepot
...
bot = telepot.Bot('6042555166:AAHifeLo9qbsA5_AonA1-nwlBtK01E_Vw1I')

def handle(msg):
    content_type, chat_type, chat_id = telepot.glance(msg)
    #if you want to allow messages only from a certain user enable the below line and use intentaion for the rest of the LOCs untill MessageLoop, To get your telegram ID use underinfobot
    #if(msg['from']['id']==************):
    if(msg['text'] == '/on'):
        on(26)
        state = GPIO.input(26)
